...
type
  ...
  public
    constructor Create(ASampleRepository: IStoreRepository); overload;
  end;
...
constructor TServiceServer.Create(ASampleRepository: IStoreRepository);
var
  Model: TOrmModel;
...
begin
  ...
  ServiceDefine(ExampleService, [IStoreService], EXAMPLE_CONTRACT);
end;
